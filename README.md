...
|<a href="https://github.com/deliciousdev">홍재윤</a>|<div align="center">회원</div>|로그인(JWT), 소셜로그인 (OAuth2), 회원가입, 비밀번호찾기, 아이디찾기, 회원정보수정, 이메일모듈, 이벤트 알림|
...
## 🟨 ERD 
![Copy of Copy of 프로젝트 erd](https://github.com/FeedTypeSNS/noldaga/assets/127002082/bd5afa0d-42e1-48c3-b9f7-5f87fc802116)
