    ...
    return `<div class="h-200px rounded-top" style="background-image:url(/assets/images/bg/05.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
            ...
            <div class="card-footer mt-3 pt-2 pb-0">
              ...
              <ul class="nav nav-bottom-line align-items-center justify-content-center justify-content-md-start mb-0 border-0">
                  ...
                  <li class="nav-item"> <a class="nav-link active" href="/nol/friend?user_id=${data.id}"> 친구목록 <span class="badge bg-success bg-opacity-10 text-success small">${data.totalFollower+data.totalFollowing}</span> </a> </li>
              </ul>
            </div>`;
}
