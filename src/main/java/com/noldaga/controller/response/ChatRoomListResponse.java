...
public class ChatRoomListResponse {
    ...
    public static ChatRoomListResponse returnResponse(ChatRoomDto roomInfo, List<UserSimpleDto> jp, ChatDto rc, int c){
        return new ChatRoomListResponse(roomInfo, jp, rc, c);
    }
